...
class HabitsSettings extends StatefulWidget {
  const HabitsSettings({Key? key}) : super(key: key);

  @override
  _HabitsSettingsState createState() => _HabitsSettingsState();
}

class _HabitsSettingsState extends State<HabitsSettings> {
