...
# WARNING: Ensure imports from `final_project` comes after this line
from final_project import app, settings, db  # noqa
from final_project.cli import create_user, cli  # noqa
